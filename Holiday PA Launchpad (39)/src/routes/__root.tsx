  ...
  head: () => ({
    meta: [
      ...
      { title: "Holiday PA — Your stay, fully serviced" },
      {
        name: "description",
        content:
          "Holiday PA connects holiday-rental guests with trusted local chefs, spas, experiences and transfers — turning any rental into a fully serviced, concierge-grade trip.",
      },
      { name: "author", content: "Holiday PA" },
